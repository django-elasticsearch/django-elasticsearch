...
class DocumentTestCase(TestCase):
    ...
    def test_model_instance_iterable_update_with_pagination(self):
        ...
        with patch(bulk) as mock_bulk, patch(parallel_bulk) as mock_parallel_bulk:
            ...
            self.assertEqual(
                mock_parallel_bulk.call_count, 0, "parallel bulk is not called"
            )
    ...
    def test_model_instance_iterable_update_with_parallel(self):
        ...
        with patch(bulk) as mock_bulk, patch(parallel_bulk) as mock_parallel_bulk:
            ...
            self.assertEqual(
                mock_parallel_bulk.call_count, 1, "parallel bulk is called"
            )
    ...
    def test_init_prepare_correct(self):
        ...
        for name, field, prep in d._prepared_fields:
            ...
            self.assertTrue(
                str(type(prep)) in e[1], "prep function is correct partial or method"
            )
    ...
    def test_init_prepare_results(self):
        ...
        self.assertEqual(
            d.prepare(car),
            {"color": "blue", "type": "imaginary", "name": "Tusla", "price": 340123.21},
        )
