...
class DEDFieldTestCase(TestCase):
    ...
    def test_get_value_from_instance_related_callable(self):
        ...
        instance = NonCallableMock(
            related=NonCallableMock(callable=Mock(return_value="bar"), attr1="foo")
        )
        self.assertEqual(field.get_value_from_instance(instance), "bar")
    ...
    def test_get_value_from_lazy_object(self):
        ...
        self.assertIsInstance(field.get_value_from_instance(instance), string_types)
        self.assertEqual(field.get_value_from_instance(instance), "foo")
...
class ObjectFieldTestCase(TestCase):
    ...
    def test_get_value_from_instance_with_inner_objectfield(self):
        ...
        instance = NonCallableMock(
            person=NonCallableMock(
                first_name="foo", last_name="bar", aditional=NonCallableMock(age=12)
            )
        )

        self.assertEqual(
            field.get_value_from_instance(instance),
            {"first_name": "foo", "last_name": "bar", "aditional": {"age": 12}},
        )
    ...
    def test_get_value_from_instance_with_none_inner_objectfield(self):
        ...
        instance = NonCallableMock(
            person=NonCallableMock(first_name="foo", last_name="bar", aditional=None)
        )

        self.assertEqual(
            field.get_value_from_instance(instance),
            {"first_name": "foo", "last_name": "bar", "aditional": {}},
        )
...
class BooleanFieldTestCase(TestCase):
    def test_get_mapping(self):
        ...
        self.assertEqual({"type": "boolean",}, field.to_dict())
...
class DateFieldTestCase(TestCase):
    def test_get_mapping(self):
        ...
        self.assertEqual({"type": "date",}, field.to_dict())
...
class TextFieldTestCase(TestCase):
    def test_get_mapping(self):
        ...
        self.assertEqual({"type": expected_type,}, field.to_dict())
...
class CompletionFieldTestCase(TestCase):
    def test_get_mapping(self):
        ...
        self.assertEqual({"type": "completion",}, field.to_dict())
...
class GeoPointFieldTestCase(TestCase):
    def test_get_mapping(self):
        ...
        self.assertEqual({"type": "geo_point",}, field.to_dict())
...
class ByteFieldTestCase(TestCase):
    def test_get_mapping(self):
        ...
        self.assertEqual({"type": "byte",}, field.to_dict())
...
class LongFieldTestCase(TestCase):
    def test_get_mapping(self):
        ...
        self.assertEqual({"type": "long",}, field.to_dict())
...
class DoubleFieldTestCase(TestCase):
    def test_get_mapping(self):
        ...
        self.assertEqual({"type": "double",}, field.to_dict())
...
class FloatFieldTestCase(TestCase):
    def test_get_mapping(self):
        ...
        self.assertEqual({"type": "float",}, field.to_dict())
...
class IpFieldTestCase(TestCase):
    def test_get_mapping(self):
        ...
        self.assertEqual({"type": "ip",}, field.to_dict())


class ListFieldTestCase(TestCase):
    def test_get_mapping(self):
        field = ListField(IntegerField(attr="foo.bar"))
        self.assertEqual({"type": "integer",}, field.to_dict())
...
class ShortFieldTestCase(TestCase):
    def test_get_mapping(self):
        ...
        self.assertEqual({"type": "short",}, field.to_dict())
